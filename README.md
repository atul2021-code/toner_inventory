...
A lightweight, responsive toner cartridge and printer fleet management system designed to run 100% client-side via GitHub Pages with persistent browser storage, automatic purchase requisition calculations, and audit history tracking.
